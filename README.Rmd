...
* Understanding text size and resolution in ggplot2 blog post by Christophe Nicault ([read his blog post](https://www.christophenicault.com/post/understand_size_dimension_ggplot2/){target="_blank"})
